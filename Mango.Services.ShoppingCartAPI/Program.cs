...
builder.Services.AddHttpClient("Coupon", q => q.BaseAddress = new Uri(builder.Configuration["ServiceUrls:CouponAPI"])).AddHttpMessageHandler<BackEndApiAuthenticationHttpClientHandler>();
